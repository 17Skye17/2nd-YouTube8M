...
def main():
    ...
    for file_ in tfrecords_path:
        video_name_str = 'distill_validate' + ('%04d' % count)
        tfrecord_name = os.path.join(file_temp_path, video_name_str + '.tfrecord')
        ...
        for string_record in record_iterator:
            ...
            video_id = example.context.feature['id'].decode("utf-8")
            # print(video_id)
